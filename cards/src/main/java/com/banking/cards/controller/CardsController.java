...
public class CardsController {
    ...
    public ResponseEntity<ResponseDto> updateCardDetails(@Valid @RequestBody CardsDto cardsDto) {
        ...
        if(isUpdated) {
            return ResponseEntity
                    ...
                    .body(ResponseDto.builder().statusCode(CardsConstants.STATUS_200).statusMsg(CardsConstants.MESSAGE_200).build());
        }else{
            return ResponseEntity
                    .status(HttpStatus.EXPECTATION_FAILED)
                    .body(ResponseDto.builder().statusCode(CardsConstants.STATUS_417).statusMsg(CardsConstants.MESSAGE_417_UPDATE).build());
        }
    }
    ...
    public ResponseEntity<ResponseDto> deleteCardDetails(@RequestParam
        ...
        if(isDeleted) {
            ...
            return ResponseEntity
                    .status(HttpStatus.EXPECTATION_FAILED)
                    .body(ResponseDto.builder().statusCode(CardsConstants.STATUS_417).statusMsg(CardsConstants.MESSAGE_417_DELETE).build());
        }
    }
